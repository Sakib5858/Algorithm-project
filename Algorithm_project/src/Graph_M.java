...
public class Graph_M
{
    ...
    public static void Create_Metro_Map(Graph_M g)
    {
        ...
        g.addEdge("Uttara North", "Uttara Center", 2);
        g.addEdge("Uttara Center", "Uttara South", 3);
        g.addEdge("Uttara South", "Pallabi", 4);
        g.addEdge("Pallabi", "Mirpur 11", 5);
        g.addEdge("Mirpur 11", "Mirpur 10", 6);
        g.addEdge("Mirpur 10", "Kazipara", 7);
        g.addEdge("Kazipara", "Shewrapara", 8);
        g.addEdge("Shewrapara", "Agargaon", 9);
        g.addEdge("Agargaon", "Bijoy Sarani", 10);
        g.addEdge("Bijoy Sarani", "Farmgate", 11);
        g.addEdge("Farmgate", "Karwan Bazar", 12);
        g.addEdge("Karwan Bazar", "Shahbag", 13);
        g.addEdge("Shahbag", "Dhaka University", 14);
        g.addEdge("Dhaka University", "Bangladesh Secretariat", 15);
        g.addEdge("Bangladesh Secretariat", "Motijheel", 16);
    }
